...
- NPC lines (one NPC or more in one Dialog Tree)
- Character lines, choices and options.
- Variables settings
- Simple tests
- Animations during and between lines
- Looping/Recurring lines
- Replacement lines (example : https://www.youtube.com/watch?v=v8eNzUtCVlY&t=1116s at 18:36)
